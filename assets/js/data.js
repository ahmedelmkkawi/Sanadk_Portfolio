/**
 * ============================================================================
 * Sanadak Portfolio — Central Projects & Site Data Configuration
 * ============================================================================
 * 
  ...
  projects: [
    {
      ...
      slug: "daniels",
      title: "Daniels",
      tagline: "portfolio site Daniels showcasing dynamic scrolling, filtering, and design transitions.",
      category: "web",
      categoryLabel: "WEB",
      description: "A sleek portfolio website built for showcasing creative designs, dynamic scrolling transitions, interactive filtering, and responsive UI components.",
    ...
    },
    {
      ...
      category: "web",
      categoryLabel: "WEB",
      description: "Full-featured online grocery & e-commerce shopping platform providing product categories, cart management, checkout flow, and payment gateway integration.",
  ...
  services: [
    {
      ...
      description: "Custom websites and web applications built with cutting-edge technologies. From sleek landing pages to complex enterprise platforms — pixel-perfect and performant.",
      tags: ["Angular", "React", "Node.js", "PHP Laravel", "Full-Stack"]
    },
    {
      icon: "brain",
      title: "Artificial Intelligence",
      description: "Harness the power of AI with custom machine learning models, chatbots, predictive analytics, and intelligent automation tailored to your business needs.",
      tags: ["ML Models", "NLP", "Computer Vision"]
    },
    {
      icon: "database",
      title: "Data Flows",
      description: "Design and implement robust data pipelines that collect, transform, and deliver data seamlessly across your organization for real-time decision making.",
      tags: ["ETL", "Pipelines", "Real-Time"]
    },
    {
      icon: "robot",
      title: "Automation",
      description: "Streamline your workflows and eliminate repetitive tasks with intelligent automation solutions — from RPA bots to custom business process automation.",
      tags: ["RPA", "Workflow", "Integration"]
    },
    {
      icon: "shield-halved",
      title: "Cybersecurity",
      description: "Protect your digital assets with comprehensive security solutions — vulnerability assessments, penetration testing, compliance, and 24/7 threat monitoring.",
      tags: ["Pen Testing", "SOC", "Compliance"]
    },
    {
      icon: "chart-pie",
      title: "Data Analysis",
      description: "Transform raw data into actionable insights with advanced analytics, interactive dashboards, and strategic reporting that drives smarter business decisions.",
      tags: ["BI Dashboards", "Analytics", "Insights"]
    },
    {
      icon: "mobile-screen",
      title: "Mobile Apps",
      description: "Native and cross-platform mobile applications that deliver exceptional user experiences. From concept to App Store — we build apps that users love and businesses rely on.",
